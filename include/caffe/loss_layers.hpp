...
class AccuracyLayer : public Layer<Dtype,Mtype> {
 ...
 protected:
  ...
  Blob<int> counts_, valid_counts_;
};
...
class SigmoidCrossEntropyLossLayer : public LossLayer<Dtype,Mtype> {
 ...
 protected:
  ...
  vector<BlobBase*> sigmoid_bottom_vec_;
  /// top vector holder to call the underlying SigmoidLayer::Forward
  vector<BlobBase*> sigmoid_top_vec_;
};
...
class SoftmaxWithLossLayer : public LossLayer<Dtype,Mtype> {
 ...
 protected:
  ...
  vector<BlobBase*> softmax_bottom_vec_;
  /// top vector holder used in call to the underlying SoftmaxLayer::Forward
  vector<BlobBase*> softmax_top_vec_;
  /// Whether to ignore instances with a certain label.
  bool has_ignore_label_;
  /// The label indicating that an instance should be ignored.
  int ignore_label_;
