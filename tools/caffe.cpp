...
//  const vector<shared_ptr<Layer<float,float> > >& layers = caffe_net.layers();
  const vector<shared_ptr<Layer<float,float> > > layers; // FIXME = caffe_net.layers();
//  const vector<vector<Blob<float>*> >& bottom_vecs = caffe_net.bottom_vecs();
  const vector<vector<Blob<float>*> > bottom_vecs; // FIXME = caffe_net.bottom_vecs();
//  const vector<vector<Blob<float>*> >& top_vecs = caffe_net.top_vecs();
  const vector<vector<Blob<float>*> > top_vecs; // FIXME = caffe_net.top_vecs();
